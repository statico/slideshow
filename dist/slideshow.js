...
(function() {
  var Menu, Slideshow, Viewport, defer,
  ...
  Menu = (function(superClass) {
    ...
    function Menu(props) {
      this._setIndex = bind(this._setIndex, this);
      this._readHash = bind(this._readHash, this);
    ...
    Menu.prototype._parseHash = function() {
      var index;
    ...
    Menu.prototype._readHash = function() {
      return this._setIndex(this._parseHash());
    };

    Menu.prototype._setIndex = function(index) {
      if (index < 0) {
        index = 0;
      }
      if (index >= this.props.paths.length) {
        index = this.rops.paths.length - 1;
      }
    ...
    Menu.prototype.componentDidMount = function() {
      ...
      window.addEventListener('keydown', (function(_this) {
        return function(e) {
          switch (e.code) {
            case 'KeyJ':
              return _this._setIndex(_this.state.index + 1);
            case 'KeyK':
              return _this._setIndex(_this.state.index - 1);
          }
        };
  ...
  Viewport = (function(superClass) {
    ...
    Viewport.prototype._maybeUpdateVideo = function() {
    ...
    Viewport.prototype.componentDidMount = function() {
      return defer((function(_this) {
        return function() {
          return _this._maybeUpdateVideo();
        };
      })(this));
    };

    Viewport.prototype.componentWillReceiveProps = function() {
      return defer((function(_this) {
        return function() {
          return _this._maybeUpdateVideo();
        };
    ...
    Viewport.prototype.render = function() {
      return React.createElement("div", {
        "id": "viewport"
      }, (!this.props.path ? React.createElement("div", null) : /\.webm$/i.test(this.props.path) ? React.createElement("video", {
        "ref": "video",
        "preload": "auto",
        "autoplay": "autoplay",
        "muted": "muted",
  ...
  Slideshow = (function(superClass) {
    ...
    Slideshow.prototype.onChange = function(index) {
      return this.setState({
        path: this.props.paths[index]
      });
    };
  ...
  defer(function() {
    ...
    xhr.onreadystatechange = function() {
      ...
      if (xhr.readyState === XMLHttpRequest.DONE) {
        ...
        return ReactDOM.render(React.createElement(Slideshow, {
          "paths": obj.paths,
          "header": header
        }), el);
      }
